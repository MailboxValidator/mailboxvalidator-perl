...
myst_html_meta = {
    "description": "MailboxValidator Perl module enable users to block disposal email, detect free email and validate if an email is valid.",
    "keywords": "MailboxValidator, Email Validation, disposable email, free email, Perl",
...
html_title = "MailboxValidator Perl"
